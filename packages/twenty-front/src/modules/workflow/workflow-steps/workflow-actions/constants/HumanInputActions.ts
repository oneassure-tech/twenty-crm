...
import { USER_FORM_ACTION } from '@/workflow/workflow-steps/workflow-actions/constants/actions/UserFormAction';
...
export const HUMAN_INPUT_ACTIONS: Array<{
  defaultLabel: string;
  type: Extract<WorkflowActionType, 'FORM' | 'USER_PROMPT' | 'USER_FORM'>;
  icon: string;
}> = [FORM_ACTION, USER_PROMPT_ACTION, USER_FORM_ACTION];
