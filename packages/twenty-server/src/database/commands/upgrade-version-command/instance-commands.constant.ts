...
import { AddOwnedRecordsRestrictionToRoleAndObjectPermissionFastInstanceCommand } from './2-20/2-20-instance-command-fast-1783527065000-add-owned-records-restriction-to-role-and-object-permission';
...
export const INSTANCE_COMMANDS = [
  ...
  AddOwnedRecordsRestrictionToRoleAndObjectPermissionFastInstanceCommand,
];
