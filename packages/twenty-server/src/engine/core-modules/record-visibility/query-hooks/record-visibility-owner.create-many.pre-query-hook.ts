...
export class RecordVisibilityOwnerCreateManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    return {
      ...payload,
      data: await this.recordVisibilityOwnerDefaultingService.defaultOwnerOnCreate(
        {
